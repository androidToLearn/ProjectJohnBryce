...
(4, 'חופשת החלומות', '2026-10-10', '2026-12-10', 50000, 'icon18.jpg'),
(3, 'ביזנס', '2026-10-10', '2026-12-10', 40000, 'icon19.jpg'),
(1, 'ארץ הקודש', '2026-10-10', '2026-10-29', 3000, 'icon21.jpg'),
(10, 'נופים מרהיבים בסלובקיה', '2026-09-10', '2026-10-10', 25000, 'icon22.jpg'),
...
(4, 'טיול עם נוף הררי', '2026-10-10', '2026-12-10', 60000, 'icon21.jpg'),
(7, 'הכי קר', '2026-07-10', '2026-12-10', 100000, 'icon21.jpg'),
(4, 'צאו לגלות בעלי חיים מרהיבים וטבע פראי', '2026-10-10', '2026-12-10', 30000, 'icon21.jpg'),
(4, 'חופשת אקסטרים', '2026-10-10', '2026-11-10', 20000, 'icon26.jpg');
